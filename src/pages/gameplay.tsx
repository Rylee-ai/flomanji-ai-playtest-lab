...
/**
 * Flomanji Gameplay Guide
 * Built from the official game data and observed simulation flows.
 * Accessible, comprehensive, and suitable for both new players and administrators.
 */
const Gameplay = () => (
