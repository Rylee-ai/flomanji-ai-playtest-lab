...
export const KeyFeaturesSection = () => {
  ...
  console.log("KeyFeaturesSection rendering");
      ...
      <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row gap-12 relative z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-1/5 relative md:z-10 mb-4 md:mb-0">
          <div className="relative">
            ...
            <Badge
              variant="outline"
              className="relative z-10 h-12 w-12 text-2xl flex items-center justify-center p-0 font-bold border-blue-500/30 bg-blue-500/10 text-blue-400 shadow-lg"
            >
              2
            </Badge>
          </div>
        ...
        <div className="w-full md:w-4/5">
          <h2 className="text-3xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-blue-400 drop-shadow-md">
            Key Features
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {/* Feature cards - ensure these render properly */}
            <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-800 shadow-lg overflow-hidden group hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
