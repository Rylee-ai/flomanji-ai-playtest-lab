 ...
 * - Responsive hero that always fills the viewport (min-h-screen)
 * - Dramatic, clear bottom-aligned Gator & Sunset background (16:9 internally)
...
export const HeroSection = ({
  ...
  return (
    ...
    >
      {/* Background image with enforced aspect ratio, covers section */}
