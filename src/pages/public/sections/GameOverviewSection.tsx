...
export const GameOverviewSection = () => {
  // Debugging to verify component rendering
  console.log("GameOverviewSection rendering");
      ...
      <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row gap-12 relative z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-1/5 relative md:z-10 mb-4 md:mb-0">
          <div className="relative">
            ...
            <Badge
              variant="outline"
              className="relative z-10 h-12 w-12 text-2xl flex items-center justify-center p-0 font-bold border-amber-500/30 bg-amber-500/10 text-amber-400 shadow-lg"
            >
              1
            </Badge>
          </div>
        ...
        <div className="w-full md:w-4/5">
          <h2 className="text-3xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-amber-200 to-amber-400 drop-shadow-md">
            Game Overview
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            {/* First card - ensure this renders properly */}
            <Card className="bg-gray-900/60 backdrop-blur-sm border-gray-800 shadow-xl overflow-hidden relative h-full flex flex-col justify-between">
            ...
            {/* Feature cards grid - ensure these render properly */}
