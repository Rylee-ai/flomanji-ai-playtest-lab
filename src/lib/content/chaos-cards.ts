...
// Function to load chaos cards from markdown content
export const loadChaosCardsFromContent = async () => {
  // This would be implemented to load cards from the content directory
  // For now, it returns the array of cards hardcoded below
  return CHAOS_CARDS;
};

// This array exists as a fallback but eventually all cards should be loaded from content files
